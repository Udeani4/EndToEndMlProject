        ...
        try:
            ...
            params={
                ...
                "Gradient Boosting":{
                    ...
                    # 'criterion':['squared_error','freiedman_mse'],
            ...
            train_model_report,test_model_report=evaluate_models(X_train=X_train,y_train=y_train,X_test=X_test,y_test=y_test,models=models,params=params) ## we created the evaluate_model function in utils.py
